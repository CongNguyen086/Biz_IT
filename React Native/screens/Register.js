...
class RegisterScreen extends Component {
    ...
    render() {
        const { fullName, phone, password, name_valid, phone_valid, loading } = this.state;
                        ...
                        >
                            ...
                            <View style={styles.loginInput}>
                                <Input
                                    ...
                                    returnKeyType="next"
                                    onSubmitEditing={() => {
                                        this.setState({ name_valid: this.validateName(fullName) });
                                    ...
                                    errorMessage={
                                        name_valid ? null : 'Please enter a valid phone number'
                                    }
                                />
                                <Input
                                    leftIcon={
